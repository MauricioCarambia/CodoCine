...
function validarModificacionUser() {
  var nombre = document.getElementById("nombreModificar").value;
  var apellido = document.getElementById("apellidoModificar").value;
  var email = document.getElementById("emailModificar").value;
  var pass = document.getElementById("passModificar").value;
  var celular = document.getElementById("celularModificar").value;
  var fecnac = document.getElementById("fecnacModificar").value;
  var genero = document.getElementById("generoModificar").value;
